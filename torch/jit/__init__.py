...
def trace(func,
    ...
    module._create_method_from_trace('forward', func, example_inputs,
                                     var_lookup_fn, _force_outplace, True)
...
def _try_compile_weak_script(fn):
    maybe_wrap_fn = _jit_internal.weak_wrap_to_fn.get(fn)
    if maybe_wrap_fn:
        fn = maybe_wrap_fn
...
def script(obj, optimize=True, _frames_up=0, _rcb=None):
    ...
    return mod
torch._jit_internal._jit_try_compile_weak_script = _try_compile_weak_script
